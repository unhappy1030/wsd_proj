            ...
            <div id="manualStepsContainer">
                <c:forEach var="step" items="${recipe.manualSteps}" varStatus="status">
                    <div class="form-row align-items-center mb-2 manual-step" data-step-id="${status.index}">
                        <input type="hidden" class="step-recipeId-input" name="manualSteps[${status.index}].recipeId" value="${recipe.id}">
    ...
    <script>
        ...
        addStepButton.addEventListener('click', function () {
            ...
            newStep.innerHTML =
                ...
                '<input type="hidden" class="step-recipeId-input" name="manualSteps[' + stepCount + '].recipeId" value=${recipe.id}>' +
                '<div class="col-8">' +
